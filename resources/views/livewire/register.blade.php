<div class="h-[1100px] overflow-hidden">
    ...
    <section class="flex overflow-hidden flex-col bg-white">
        <div class="flex relative flex-col justify-center items-center px-20 py-28 w-full min-h-[982px] max-md:px-5 max-md:py-24 max-md:max-w-full">
            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/a684c8edffc568bb78ed3c9e3271669f15a2bbb8e350a150343a981daf829b9c?placeholderIfAbsent=true&apiKey=8596518292344287a6dbe083b6dc8023" alt="" class="object-cover absolute inset-0 w-full h-screen"/>
            <div class="flex relative flex-col mb-0 max-w-full w-[355px] max-md:mb-2.5">
                ...
                <section x-data="{ isOpen: @entangle('isOpen') }" class="flex flex-col justify-center items-center px-5 py-24 md:px-20 md:py-48 h-screen">
                    <article
                        x-show="isOpen"
